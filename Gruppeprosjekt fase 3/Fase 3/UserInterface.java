...
public class UserInterface
{
    ...
    private void processCommand()
    {
        ...
        switch (value)
        {
                ...
                switch (value2)
                {
                    ...
                    case "2":
                    {
                        ...
                        while(!loop.equals("y"))
                        {
                            ...
                            registry.addNewMagazine(new Magazine(title, author, publisher, releaseDate, edition));
                            System.out.println("\nIs this correct?" +"y/n?" + 
                            "\nTitle: " + title +
                            "\nAuthor: " + author +
                            "\nPublisher: " + publisher +
            ...
            case "3":
            {
                if (registry.bookLibraryIsEmpty())
                {
            ...
            case "6": 
            {
                ...
                String title = scanner.nextLine();
                Magazine foundMagazine = registry.findMagazineByTitle(title);
