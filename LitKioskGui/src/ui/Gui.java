...
public class Gui{
    ...
    private Button listBooksBtn, listMagsBtn, helpBtn, closeBtn, addBooksBtn,
            backBtn, editBtn, search;
    ...
    private void mainScene(){
        ...
        helpBtn.setOnAction(e -> AlertBox.displayInfo("Title", "Header", "Message"));
